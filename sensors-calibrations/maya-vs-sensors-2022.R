...
# uva1.lm <- lm(Q_UVA2.CIE ~ UVA_umol + UVB_umol + 0, data = all_irrads.tb)
# summary(uva1.lm)
#
# uva2.lm <- lm(Q_UVA1.CIE ~ UVA_umol + blue_sellaro_umol + 0, data = all_irrads.tb)
# summary(uva2.lm)
#
# uva.lm <- lm(Q_UVA.ISO ~ UVA_umol + UVB_umol + 0, data = all_irrads.tb)
# summary(uva.lm)
#
