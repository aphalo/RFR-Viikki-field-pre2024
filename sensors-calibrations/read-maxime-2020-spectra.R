...
maxime_2020.mspct <- collect2mspct()
autoplot(maxime_2020.mspct, facets = FALSE)
autoplot(smooth_spct(maxime_2020.mspct), facets = FALSE)

save(maxime_2020.mspct, file = "./sensors-calibrations/maxime-2020-mspct.rda")
